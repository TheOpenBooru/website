...
import { hasPermission, permissions } from "js/booru/account/permissions";
...
export const Booru = { Errors, profile, register, login, logout, Store, hasPermission, permissions };
